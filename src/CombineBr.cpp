...
bool CombineBr::processGEP(IRBuilder<> builder, GetElementPtrInst *instr) {
...
bool CombineBr::processFunction(Function *func) {
...
void CombineBr::handleFunctions(Module &M) {
...
bool CombineBr::runOnModule(Module &M) {
  handleFunctions(M);
  return true;
}

bool CombineBr::normalizeModule(Module &M) {
  debug() << "\n=========================================\n"
          << "Combining Direct Br...\n";
...
static RegisterPass<CombineBr> X("CombineBr",
                                 "CombineBr",
